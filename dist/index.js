...
await app.register(swagger, {
    openapi: {
        info: {
            ...
            version: "1.0.0",
            description: "API que inspeciona o canal do YouTube do Vestígios RPG e retorna os vídeos cacheados. Documentação interativa para testar os endpoints.",
        },
        servers: [
            {
...
app.post("/api/refresh", async (req, reply) => {
    try {
        ...
        return reply.internalServerError(err instanceof Error ? err.message : "Erro desconhecido");
    }
});
